...
constexpr Token_kind t_tok        = make_token(112);
constexpr Token_kind f_tok        = make_token(113);
constexpr Token_kind not_tok      = make_token(114);
constexpr Token_kind and_tok      = make_token(115);
constexpr Token_kind or_tok       = make_token(116);
constexpr Token_kind lsh_tok      = make_token(117);
// Type names
