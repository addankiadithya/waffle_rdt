...
pp_not(std::ostream& os,Not* t) {
  os << "Not" << group(pretty(t->arg()));
}

void 
pp_and(std::ostream& os,And* t) {
  os << "And {" << group(pretty(t->firstarg()))
     << ", "
  	 << group(pretty(t->secondarg()))
  	 << "}";
}
void 
pp_or(std::ostream& os,Or* t) {
  os << "Or {" << group(pretty(t->firstarg()))
     << ", "
  	 << group(pretty(t->secondarg()))
  	 << "}";
}
void 
pp_lsh(std::ostream& os,Lsh* t) {
  os << "Lsh {" << group(pretty(t->firstarg()))
     << ", "
  	 << group(pretty(t->secondarg()))
  	 << "}";
}
